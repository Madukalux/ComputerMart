...
<body> 
	...
	<header>	
	<a class="logo-wed" href="index.php">
    <img alt="computemart logo" src="pictures/mart11.png" style="width: 160px; margin-left: -30px; margin-top: -12px;"></a>
	<nav class="t-nav">
		<div class="top-nav">
		<ul class="menu-bar">
			<li><a href="index.php">Home</a></li>
			<li><a href="product-dress.php">Product</a></li>
			<li><a href="contact.php">Contact Us</a></li>
			<li><a href="index2.php">Chat Area</a></li>
		</ul>
		
		</div>
		<!-- <img id="log-bag" src="images/main/bag.png" onclick="openthis();toggleCart();"></img>  -->
		<a href="shoping cart/index.php">	<img id="log-bag" src="images/main/bag.png" ></img> </a>
		<?php
